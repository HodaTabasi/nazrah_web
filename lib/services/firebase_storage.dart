...
void uploadMultipleToStorage(String uid, String phoneNumber, DateTime dateTime,
  ...
  // fb.StorageReference storageRef = fb.storage().ref(path);
  // fb.UploadTaskSnapshot uploadTaskSnapshot = await storageRef.put(path).future.then((value) async {
  ...
  //       .collection('ads_temp')
  //       .doc(dateTime.toString())
  //       .update({'photo_url $index': value.ref.getDownloadURL(), 'photo_limit': total})
  //       : FirebaseFirestore.instance
  //       .collection('users')
  //       .doc(phoneNumber)
  //       .collection('ads_temp')
  //       .doc(dateTime.toString())
  //       .set({'photo_url $index': value.ref.getDownloadURL(), 'photo_limit': total});
  // });
  //
    ...
    value.ref.getDownloadURL().then((value) async {
      ...
      (exist.exists)
          ? FirebaseFirestore.instance
              ...
              .doc(dateTime.toString())
              .update(
                  {'photo_url $index': value.toString(), 'photo_limit': total})
          : FirebaseFirestore.instance
              .collection('users')
              .doc(phoneNumber)
              .collection('ads_temp')
